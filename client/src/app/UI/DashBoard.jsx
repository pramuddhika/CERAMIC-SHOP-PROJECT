...
const DashBoard = () => {
  ...
  const fecthMaterialPieChartData = async () => {
    try {
      const materialPieChartData = await axios.get("/api/dashboard/materialPieChart");
  ...
  const fecthPast30DaysOrderData = async () => {
    try {
      const past30DaysOrderData = await axios.get("/api/dashboard/past30DaysOrder");
  ...
  const fecthMonthlyIncomeExpenseData = async () => {
    try {
      const monthlyIncomeExpenseData = await axios.get("/api/dashboard/monthlyIncomeExpense");
  ...
  return (
    <div className="flex flex-col">
      <div className="grid grid-cols-3 gap-6 mb-6">
        <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl shadow-lg p-4 transition-all hover:shadow-xl hover:scale-[1.02]">
          <div className="h-full flex flex-col justify-between">
            <div>
              <h1 className="text-2xl font-bold text-gray-800">Total Income</h1>
              <p className="text-sm text-gray-600">Last 30 Days</p>
            </div>
            <div className="text-3xl font-bold text-blue-600 mt-2">Rs.{cardsData.totalIncome30}</div>
          </div>
        </div>
        <div className="bg-gradient-to-br from-red-50 to-red-100 rounded-xl shadow-lg p-4 transition-all hover:shadow-xl hover:scale-[1.02]">
          <div className="h-full flex flex-col justify-between">
            <div>
              <h1 className="text-2xl font-bold text-gray-800">Total Expense</h1>
              <p className="text-sm text-gray-600">Last 30 Days</p>
            </div>
            <div className="text-3xl font-bold text-red-600 mt-2">Rs.{cardsData.totalExpense30}</div>
          </div>
        </div>
        <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl shadow-lg p-4 transition-all hover:shadow-xl hover:scale-[1.02]">
          <div className="h-full flex flex-col justify-between">
            <div>
              <h1 className="text-2xl font-bold text-gray-800">Total Order</h1>
              <p className="text-sm text-gray-600">Last 30 Days</p>
            </div>
            <div className="text-3xl font-bold text-green-600 mt-2">{cardsData.totalOrderCount30}</div>
          </div>
        </div>
      </div>
      <div className="grid grid-cols-3 gap-6 mb-6">
        <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl shadow-lg p-4 transition-all hover:shadow-xl hover:scale-[1.02]">
          <div className="h-full flex flex-col justify-between">
            <div>
              <h1 className="text-2xl font-bold text-gray-800">Total Active Customer</h1>
              <p className="text-sm text-gray-600">Last 30 Days</p>
            </div>
            <div className="text-3xl font-bold text-purple-600 mt-2">{cardsData.activeCustomer30}</div>
          </div>
        </div>
        <div className="bg-gradient-to-br from-yellow-50 to-yellow-100 rounded-xl shadow-lg p-4 transition-all hover:shadow-xl hover:scale-[1.02]">
          <div className="h-full flex flex-col justify-between">
            <div>
              <h1 className="text-2xl font-bold text-gray-800">Pending Income</h1>
              <p className="text-sm text-gray-600">Last 30 Days</p>
            </div>
            <div className="text-3xl font-bold text-yellow-600 mt-2">Rs.{cardsData.pendingIncome}</div>
          </div>
        </div>
        <div className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-xl shadow-lg p-4 transition-all hover:shadow-xl hover:scale-[1.02]">
          <div className="h-full flex flex-col justify-between">
            <div>
              <h1 className="text-2xl font-bold text-gray-800">Pending Expense</h1>
              <p className="text-sm text-gray-600">Last 30 Days</p>
            </div>
            <div className="text-3xl font-bold text-orange-600 mt-2">Rs.{cardsData.pendingExpense}</div>
          </div>
        </div>
      </div>
      <div className="grid grid-cols-2 gap-6">
        <div className="bg-white rounded-xl shadow-lg p-6 h-[400px] transition-all hover:shadow-xl relative">
          <h2 className="text-2xl font-bold mb-4 text-gray-800">Material Distribution</h2>
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 h-[400px] transition-all hover:shadow-xl relative">
          <h2 className="text-2xl font-bold mb-4 text-gray-800">Product Stock Distribution</h2>
          <div className="h-[320px]">
      ...
      <div className="grid gap-6 mb-6 mt-3">
        <div className="bg-white rounded-xl shadow-lg p-6 h-[400px] transition-all hover:shadow-xl relative">
          <h2 className="text-2xl font-bold mb-4 text-gray-800">Orders Last 30 Days</h2>
          <div className="h-[320px]">
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 h-[400px] transition-all hover:shadow-xl relative">
          <h2 className="text-2xl font-bold mb-4 text-gray-800">Monthly Income vs Expense</h2>
          <div className="h-[320px]">
